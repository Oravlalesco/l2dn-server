...
public static class Scripts
{
    public static void RegisterHandlers()
    {
        ...
        effectHandler.registerHandler("AttackBehind", stat => new AttackBehind(stat));
        ...
        effectHandler.registerHandler("Betray", stat => new Betray(stat));
        effectHandler.registerHandler("Blink", stat => new Blink(stat));
        effectHandler.registerHandler("BlinkSwap", stat => new BlinkSwap(stat));
        ...
        effectHandler.registerHandler("BlockChat", stat => new BlockChat(stat));
        effectHandler.registerHandler("BlockControl", stat => new BlockControl(stat));
        effectHandler.registerHandler("BlockEscape", stat => new BlockEscape(stat));
        effectHandler.registerHandler("BlockMove", stat => new BlockMove(stat));
        effectHandler.registerHandler("BlockParty", stat => new BlockParty(stat));
        effectHandler.registerHandler("BlockResurrection", stat => new BlockResurrection(stat));
        effectHandler.registerHandler("BlockSkill", stat => new BlockSkill(stat));
        effectHandler.registerHandler("BlockTarget", stat => new BlockTarget(stat));
        ...
        effectHandler.registerHandler("BuffBlock", stat => new BuffBlock(stat));
        effectHandler.registerHandler("CallLearnedSkill", stat => new CallLearnedSkill(stat));
        effectHandler.registerHandler("CallParty", stat => new CallParty(stat));
        ...
        effectHandler.registerHandler("CallTargetParty", stat => new CallTargetParty(stat));
        effectHandler.registerHandler("CheapShot", stat => new CheapShot(stat));
        ...
        effectHandler.registerHandler("ChangeFishingMastery", stat => new ChangeFishingMastery(stat));
        ...
        effectHandler.registerHandler("Compelling", stat => new Compelling(stat));
        effectHandler.registerHandler("Confuse", stat => new Confuse(stat));
        effectHandler.registerHandler("ConsumeBody", stat => new ConsumeBody(stat));
        effectHandler.registerHandler("ConvertItem", stat => new ConvertItem(stat));
        ...
        effectHandler.registerHandler("DebuffBlock", stat => new DebuffBlock(stat));
        ...
        effectHandler.registerHandler("DetectHiddenObjects", stat => new DetectHiddenObjects(stat));
        effectHandler.registerHandler("Detection", stat => new Detection(stat));
        effectHandler.registerHandler("DisableSkill", stat => new DisableSkill(stat));
        effectHandler.registerHandler("DisableTargeting", stat => new DisableTargeting(stat));
        effectHandler.registerHandler("Disarm", stat => new Disarm(stat));
        effectHandler.registerHandler("Disarmor", stat => new Disarmor(stat));
        effectHandler.registerHandler("DispelAll", stat => new DispelAll(stat));
        ...
        effectHandler.registerHandler("DoubleCast", stat => new DoubleCast(stat));
        effectHandler.registerHandler("DuelistFury", stat => new DuelistFury(stat));
        ...
        effectHandler.registerHandler("EnableCloak", stat => new EnableCloak(stat));
        ...
        effectHandler.registerHandler("Faceoff", stat => new Faceoff(stat));
        ...
        effectHandler.registerHandler("Fear", stat => new Fear(stat));
        ...
        effectHandler.registerHandler("Flag", stat => new Flag(stat));
        ...
        effectHandler.registerHandler("FocusMaxMomentum", stat => new FocusMaxMomentum(stat));
        effectHandler.registerHandler("FocusSouls", stat => new FocusSouls(stat));
        effectHandler.registerHandler("GetAgro", stat => new GetAgro(stat));
        ...
        effectHandler.registerHandler("Grow", stat => new Grow(stat));
        effectHandler.registerHandler("HairAccessorySet", stat => new HairAccessorySet(stat));
        effectHandler.registerHandler("Harvesting", stat => new Harvesting(stat));
        ...
        effectHandler.registerHandler("Hide", stat => new Hide(stat));
        ...
        effectHandler.registerHandler("HpCpHealCritical", stat => new HpCpHealCritical(stat));
        ...
        effectHandler.registerHandler("IgnoreDeath", stat => new IgnoreDeath(stat));
        ...
        effectHandler.registerHandler("ImmobilePetBuff", stat => new ImmobilePetBuff(stat));
        ...
        effectHandler.registerHandler("Lucky", stat => new Lucky(stat));
        ...
        effectHandler.registerHandler("Mute", stat => new Mute(stat));
        ...
        effectHandler.registerHandler("NoblesseBless", stat => new NoblesseBless(stat));
        effectHandler.registerHandler("OpenChest", stat => new OpenChest(stat));
        effectHandler.registerHandler("OpenCommonRecipeBook", stat => new OpenCommonRecipeBook(stat));
        effectHandler.registerHandler("OpenDoor", stat => new OpenDoor(stat));
        effectHandler.registerHandler("OpenDwarfRecipeBook", stat => new OpenDwarfRecipeBook(stat));
        effectHandler.registerHandler("Passive", stat => new Passive(stat));
        ...
        effectHandler.registerHandler("PhysicalAttackMute", stat => new PhysicalAttackMute(stat));
        ...
        effectHandler.registerHandler("PhysicalMute", stat => new PhysicalMute(stat));
        effectHandler.registerHandler("PhysicalShieldAngleAll", stat => new PhysicalShieldAngleAll(stat));
        ...
        effectHandler.registerHandler("Plunder", stat => new Plunder(stat));
        effectHandler.registerHandler("PolearmSingleTarget", stat => new PolearmSingleTarget(stat));
        effectHandler.registerHandler("ProtectionBlessing", stat => new ProtectionBlessing(stat));
        effectHandler.registerHandler("ProtectDeathPenalty", stat => new ProtectDeathPenalty(stat));
        ...
        effectHandler.registerHandler("RebalanceHP", stat => new RebalanceHP(stat));
        effectHandler.registerHandler("RebalanceHPSummon", stat => new RebalanceHPSummon(stat));
        ...
        effectHandler.registerHandler("Root", stat => new Root(stat));
        effectHandler.registerHandler("SacrificeSummon", stat => new SacrificeSummon(stat));
        effectHandler.registerHandler("SafeFallHeight", stat => new SafeFallHeight(stat));
        effectHandler.registerHandler("SayhaGraceSupport", stat => new SayhaGraceSupport(stat));
        ...
        effectHandler.registerHandler("ServitorShareSkills", stat => new ServitorShareSkills(stat));
        ...
        effectHandler.registerHandler("SilentMove", stat => new SilentMove(stat));
        ...
        effectHandler.registerHandler("Sow", stat => new Sow(stat));
        ...
        effectHandler.registerHandler("Spoil", stat => new Spoil(stat));
        ...
        effectHandler.registerHandler("SummonPet", stat => new SummonPet(stat));
        ...
        effectHandler.registerHandler("TakeCastleStart", stat => new TakeCastleStart(stat));
        effectHandler.registerHandler("TakeFort", stat => new TakeFort(stat));
        effectHandler.registerHandler("TakeFortStart", stat => new TakeFortStart(stat));
        ...
        effectHandler.registerHandler("TargetMe", stat => new TargetMe(stat));
        ...
        effectHandler.registerHandler("TeleportToPlayer", stat => new TeleportToPlayer(stat));
        effectHandler.registerHandler("TeleportToSummon", stat => new TeleportToSummon(stat));
        effectHandler.registerHandler("TeleportToTarget", stat => new TeleportToTarget(stat));
        effectHandler.registerHandler("TeleportToTeleportLocation", stat => new TeleportToTeleportLocation(stat));
        ...
        effectHandler.registerHandler("UnsummonAgathion", stat => new UnsummonAgathion(stat));
        effectHandler.registerHandler("UnsummonServitors", stat => new UnsummonServitors(stat));
        effectHandler.registerHandler("Untargetable", stat => new Untargetable(stat));
        ...
        skillConditionHandler.registerHandler("BuildAdvanceBase", stat => new BuildAdvanceBaseSkillCondition(stat));
        skillConditionHandler.registerHandler("BuildCamp", stat => new BuildCampSkillCondition(stat));
        skillConditionHandler.registerHandler("CanAddMaxEntranceInzone",
            stat => new CanAddMaxEntranceInzoneSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("CanChangeVitalItemCount",
            stat => new CanChangeVitalItemCountSkillCondition(stat));

        skillConditionHandler.registerHandler("CanEnchantAttribute",
            stat => new CanEnchantAttributeSkillCondition(stat));

        skillConditionHandler.registerHandler("CanMountForEvent", stat => new CanMountForEventSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("CanSummon", stat => new CanSummonSkillCondition(stat));
        skillConditionHandler.registerHandler("CanSummonCubic", stat => new CanSummonCubicSkillCondition(stat));
        skillConditionHandler.registerHandler("CanSummonMulti", stat => new CanSummonMultiSkillCondition(stat));
        skillConditionHandler.registerHandler("CanSummonPet", stat => new CanSummonPetSkillCondition(stat));
        skillConditionHandler.registerHandler("CanSummonSiegeGolem",
            stat => new CanSummonSiegeGolemSkillCondition(stat));

        skillConditionHandler.registerHandler("CanTakeFort", stat => new CanTakeFortSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("CanTransformInDominion",
            stat => new CanTransformInDominionSkillCondition(stat));

        skillConditionHandler.registerHandler("CanUntransform", stat => new CanUntransformSkillCondition(stat));
        skillConditionHandler.registerHandler("CanUseInBattlefield",
            stat => new CanUseInBattlefieldSkillCondition(stat));

        skillConditionHandler.registerHandler("CanUseInDragonLair", stat => new CanUseInDragonLairSkillCondition(stat));
        skillConditionHandler.registerHandler("CanUseSwoopCannon", stat => new CanUseSwoopCannonSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("ConsumeBody", stat => new ConsumeBodySkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("EquipShield", stat => new EquipShieldSkillCondition(stat));
        skillConditionHandler.registerHandler("EquipSigil", stat => new EquipSigilSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("NotFeared", stat => new NotFearedSkillCondition(stat));
        skillConditionHandler.registerHandler("NotInUnderwater", stat => new NotInUnderwaterSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpAgathionEnergy", stat => new OpAgathionEnergySkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpCallPc", stat => new OpCallPcSkillCondition(stat));
        skillConditionHandler.registerHandler("OpCanEscape", stat => new OpCanEscapeSkillCondition(stat));
        skillConditionHandler.registerHandler("OpCanNotUseAirship", stat => new OpCanNotUseAirshipSkillCondition(stat));
        skillConditionHandler.registerHandler("OpCannotUseTargetWithPrivateStore",
            stat => new OpCannotUseTargetWithPrivateStoreSkillCondition(stat));

        skillConditionHandler.registerHandler("OpChangeWeapon", stat => new OpChangeWeaponSkillCondition(stat));
        skillConditionHandler.registerHandler("OpCheckAbnormal", stat => new OpCheckAbnormalSkillCondition(stat));
        skillConditionHandler.registerHandler("OpCheckAccountType", stat => new OpCheckAccountTypeSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpCheckCrtEffect", stat => new OpCheckCrtEffectSkillCondition(stat));
        skillConditionHandler.registerHandler("OpCheckFlag", stat => new OpCheckFlagSkillCondition(stat));
        skillConditionHandler.registerHandler("OpCheckOnGoingEventCampaign",
            stat => new OpCheckOnGoingEventCampaignSkillCondition(stat));

        skillConditionHandler.registerHandler("OpCheckPcbangPoint", stat => new OpCheckPcbangPointSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpEnchantRange", stat => new OpEnchantRangeSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpFishingCast", stat => new OpFishingCastSkillCondition(stat));
        skillConditionHandler.registerHandler("OpFishingPumping", stat => new OpFishingPumpingSkillCondition(stat));
        skillConditionHandler.registerHandler("OpFishingReeling", stat => new OpFishingReelingSkillCondition(stat));
        skillConditionHandler.registerHandler("OpHaveSummon", stat => new OpHaveSummonSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpMainjob", stat => new OpMainjobSkillCondition(stat));
        skillConditionHandler.registerHandler("OpNeedAgathion", stat => new OpNeedAgathionSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpNotCursed", stat => new OpNotCursedSkillCondition(stat));
        skillConditionHandler.registerHandler("OpNotInPeacezone", stat => new OpNotInPeacezoneSkillCondition(stat));
        skillConditionHandler.registerHandler("OpNotInstantzone", stat => new OpNotInstantzoneSkillCondition(stat));
        skillConditionHandler.registerHandler("OpNotOlympiad", stat => new OpNotOlympiadSkillCondition(stat));
        skillConditionHandler.registerHandler("OpNotTerritory", stat => new OpNotTerritorySkillCondition(stat));
        skillConditionHandler.registerHandler("OpOlympiad", stat => new OpOlympiadSkillCondition(stat));
        skillConditionHandler.registerHandler("OpPeacezone", stat => new OpPeacezoneSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpRestartPoint", stat => new OpRestartPointSkillCondition(stat));
        skillConditionHandler.registerHandler("OpResurrection", stat => new OpResurrectionSkillCondition(stat));
        skillConditionHandler.registerHandler("OpSiegeHammer", stat => new OpSiegeHammerSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpStrider", stat => new OpStriderSkillCondition(stat));
        skillConditionHandler.registerHandler("OpSubjob", stat => new OpSubjobSkillCondition(stat));
        skillConditionHandler.registerHandler("OpSweeper", stat => new OpSweeperSkillCondition(stat));
        skillConditionHandler.registerHandler("OpTargetAllItemType",
            stat => new OpTargetAllItemTypeSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("OpTargetMyPledgeAcademy",
            stat => new OpTargetMyPledgeAcademySkillCondition(stat));

        skillConditionHandler.registerHandler("OpTargetNpc", stat => new OpTargetNpcSkillCondition(stat));
        skillConditionHandler.registerHandler("OpTargetPc", stat => new OpTargetPcSkillCondition(stat));
        skillConditionHandler.registerHandler("OpTargetWeaponAttackType",
            stat => new OpTargetWeaponAttackTypeSkillCondition(stat));

        skillConditionHandler.registerHandler("OpTerritory", stat => new OpTerritorySkillCondition(stat));
        skillConditionHandler.registerHandler("OpUnlock", stat => new OpUnlockSkillCondition(stat));
        skillConditionHandler.registerHandler("OpUseFirecracker", stat => new OpUseFirecrackerSkillCondition(stat));
        skillConditionHandler.registerHandler("OpUsePraseed", stat => new OpUsePraseedSkillCondition(stat));
        skillConditionHandler.registerHandler("OpWyvern", stat => new OpWyvernSkillCondition(stat));
        skillConditionHandler.registerHandler("PossessHolything", stat => new PossessHolythingSkillCondition(stat));
        ...
        skillConditionHandler.registerHandler("TargetItemCrystalType",
            stat => new TargetItemCrystalTypeSkillCondition(stat));

        skillConditionHandler.registerHandler("TargetMyMentee", stat => new TargetMyMenteeSkillCondition(stat));
